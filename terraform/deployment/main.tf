module "main" {
  ...
  environment_private_dns_zone_id   = data.terraform_remote_state.runners.outputs.private_dns_zone_ids["dev"]
  environment_private_dns_zone_name = data.terraform_remote_state.runners.outputs.private_dns_zone_names["dev"]
